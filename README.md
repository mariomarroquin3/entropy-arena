...
**Assignment multisig con Sparrow (firmantes independientes, xpub, watch-only):** ver [docs/GUIA_ASSIGNMENT.md](docs/GUIA_ASSIGNMENT.md) (`signer_export.py`, `build_descriptor.py`, `verify_watch_only.py`).
